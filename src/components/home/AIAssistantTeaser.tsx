  ...
  return (
    <section className="py-24 bg-neutral-100 dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-background rounded-2xl p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 shadow-sm border border-neutral-200 dark:border-neutral-800">
          
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 dark:bg-neutral-800 text-xs font-medium uppercase tracking-wider mb-6">
          ...
          <div className="flex-1 w-full relative">
            <div className="aspect-square max-w-sm mx-auto bg-neutral-100 dark:bg-neutral-800 rounded-xl relative overflow-hidden border border-neutral-200 dark:border-neutral-700 p-6 flex flex-col">
              <div className="flex gap-4 mb-6">
                ...
                <div className="bg-neutral-200 dark:bg-neutral-700 rounded-2xl rounded-tl-none px-4 py-3 text-sm">
              ...
              <div className="flex gap-4 self-end flex-row-reverse">
                <div className="w-8 h-8 rounded-full bg-neutral-300 dark:bg-neutral-600 flex-shrink-0"></div>
            ...
            {/* Decorative blurs */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-neutral-300 dark:bg-neutral-600 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-neutral-400 dark:bg-neutral-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
          </div>
