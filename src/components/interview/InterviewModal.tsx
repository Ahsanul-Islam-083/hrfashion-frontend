  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true">
      <div className="bg-background w-full max-w-2xl rounded-sm border border-neutral-200 dark:border-neutral-800 shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {screen === "loading" && (
            <div className="flex flex-col items-center justify-center py-16 gap-4">
              ...
              <p className="text-neutral-500 text-sm">Preparing your interview questions...</p>
              <p className="text-neutral-400 text-xs">The AI is analyzing the job requirements and your resume.</p>
            </div>
          )}
          ...
          {screen === "questions" && currentQuestion && (
            <div className="space-y-6">
              ...
              {/* Question */}
              <div className="p-5 bg-neutral-50 dark:bg-neutral-900 rounded-sm border border-neutral-200 dark:border-neutral-800">
                <p className="text-base font-medium leading-relaxed">{currentQuestion.question}</p>
              </div>

              {/* Answer */}
              <div className="space-y-1">
                <label className="text-xs uppercase tracking-widest text-neutral-500 font-medium">Your Answer</label>
                <textarea
                  rows={6}
                ...
                {questions.map((_, i) => (
                  <div
                    ...
                    className={`w-1.5 h-1.5 rounded-full transition-colors ${
                      i === currentQ ? "bg-foreground" : answers[questions[i].id] ? "bg-neutral-400" : "bg-neutral-200 dark:bg-neutral-700"
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="space-y-6">
              <div className="flex flex-col items-center py-8 gap-4">
                ...
                <div className="text-center">
                  <p className="text-sm text-neutral-500 mb-2">Interview Score</p>
              ...
              {interview.feedback && (
                <div className="p-5 bg-neutral-50 dark:bg-neutral-900 rounded-sm border border-neutral-200 dark:border-neutral-800 space-y-2">
                  <p className="text-xs uppercase tracking-widest text-neutral-500 font-medium">AI Feedback</p>
              ...
              <div className="space-y-3">
                <p className="text-xs uppercase tracking-widest text-neutral-500 font-medium">Interview Q&A</p>
        ...
        {/* Footer */}
        {screen === "questions" && (
          <div className="p-6 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 flex justify-between items-center flex-shrink-0">
            <button
              type="button"
              onClick={() => setCurrentQ(q => Math.max(0, q - 1))}
              disabled={currentQ === 0}
              className="px-5 py-2.5 border border-neutral-200 dark:border-neutral-800 text-sm font-medium rounded-sm hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors disabled:opacity-40"
            >
              Back
            </button>
            <button
        ...
        {screen === "results" && (
          <div className="p-6 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 flex justify-end flex-shrink-0">
            <button
              onClick={onClose}
