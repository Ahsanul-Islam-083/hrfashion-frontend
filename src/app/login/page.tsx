    ...
    <PageMotion>
      <div className="max-w-md w-full mx-auto p-8 bg-background rounded-sm border border-card-border shadow-sm mt-12 md:mt-24 mb-24">
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm">Sign in to your HR Fashion account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <Link href="#" className="text-xs text-muted hover:text-foreground underline underline-offset-4">Forgot?</Link>
            </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          <button 
            ...
            className="w-full py-3 border border-card-border text-sm font-medium rounded-sm hover:bg-card transition-colors"
          >
            Use Demo Account
          </button>
        </div>
